<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\property\upd.html";i:1515726449;s:83:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\layout.html";i:1515742315;s:90:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\navbar.html";i:1512359202;s:92:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\slidebar.html";i:1515476727;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<ul class="layui-nav layui-nav-tree"  lay-filter="test">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 10px;">
            ﻿
<form class="layui-form" action="<?php echo url('property/updhanddle'); ?>" method="post" enctype="multipart/form-data">
	<input type="hidden" name="property_id" value="<?php echo $property_find['property_id']; ?>">

	<div class="layui-form-item layui-col-md6">
		<label class="layui-form-label">属性名称</label>
		<div class="layui-input-block">
			<input id="property_name" name="property_name" placeholder="请输入商品名称"  type="text" value="<?php echo $property_find['property_name']; ?>"  class="layui-input" required>
		</div>
	</div>
	...
	<div class="layui-form-item layui-col-md6">
		...
		<div class="layui-input-block">
			<select name="property_pid" lay-filter="">
				...
				<option name="property_pid" value="<?php echo $vo3['cate_id']; ?>" type="text"
					   <?php if($property_find['property_pid'] == $vo3['cate_id']): ?>
						selected=""
					   <?php endif; ?>
				/>
	...
	<button type="submit" class="layui-btn">修改属性</button>
