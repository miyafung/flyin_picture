...
<form action="<?php echo url('cate/updhanddle'); ?>" method="post" class="layui-form">
	<input type="hidden" name="cate_id" value="<?php echo $cate_find['cate_id']; ?>">

	<div class="layui-form-item layui-col-md6">
		<label class="layui-form-label">分类名称 </label>
		<div class="layui-input-block">
			<input name="cate_name" placeholder="请输入分类名称"  type="text" value="<?php echo $cate_find['cate_name']; ?>" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item layui-col-md6">
		...
		<div class="layui-input-block">
			<select name="cate_pid" lay-filter="">
				...
				<?php if($vo['cate_id'] == $cate_find['cate_pid']): ?>
				selected=""
				<?php endif; ?>
				><?php echo $vo['str']; ?><?php echo $vo['cate_name']; ?></option>
	...
	<div class="layui-form-item layui-col-md12">
		<button type="submit" class="layui-btn" lay-submit="" lay-filter="">修改分类</button>
