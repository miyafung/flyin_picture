<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\goods\goodslist.html";i:1515743753;s:83:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\layout.html";i:1516011151;s:90:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\navbar.html";i:1512359202;s:92:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\slidebar.html";i:1516011179;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<a class="green" href="<?php echo url('goods/add'); ?>">
...
<div class="layui-inline">
	...
	<select onchange=mbar(this) name="select" class="layui-select">
		...
		<option value="<?php echo url('goods/goodslist',array('goods_pid'=>$vo3['cate_id'])); ?>" >&nbsp;&nbsp;&nbsp;&nbsp;-- --<?php echo $vo3['cate_name']; ?></option>
...
<table  class="layui-table">
	...
	<?php if(is_array($goods_info) || $goods_info instanceof \think\Collection || $goods_info instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<tr>
			...
			<td><img src="<?php echo $vo['goods_thumb']; ?>" width="100"></td>
			<td>
			...
			<td class=" ">
				...
				<a class="red" href="javascript:if(confirm('确认删除？')) location='<?php echo url('goods/keywordsdelhanddle',array('goods_id'=>$vo['goods_id'],'keywords_name'=>$vo1['keywords_name'])); ?>'">
					<i style="color: #ac3100" class="fa fa-trash" aria-hidden="true"></i>
				</a><br/>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				<form method="post" action="<?php echo url('goods/keywordsaddhanddle'); ?>">
					<input type="text" name="<?php echo $vo['goods_id']; ?>" placeholder="请输入关键字" autocomplete="off">
			...
			<td>
				<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
					...
					<a class="red" href="javascript:if(confirm('确认删除？')) location='<?php echo url('goods/del',array('goods_id'=>$vo['goods_id'])); ?>'">
						<i style="color: #ac3100" class="fa fa-trash" aria-hidden="true"></i>
					</a>

					<a class="green" href="<?php echo url('goods/addproperty',array('goods_id'=>$vo['goods_id'])); ?>">
						<i style="color: #60ac6d" class="fa fa-pencil"></i>
					</a>
				</div>
			</td>
