<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\admin\adminlist.html";i:1512359336;s:83:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\layout.html";i:1516011151;s:90:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\navbar.html";i:1512359202;s:92:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\slidebar.html";i:1516011179;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form action="<?php echo url('cate/sort'); ?>" method="post">
	<table class="layui-table">
		...
		<tbody >
			<?php if(is_array($admin_select) || $admin_select instanceof \think\Collection || $admin_select instanceof \think\Paginator): $i = 0; $__LIST__ = $admin_select;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="odd">
					<td class=" ">
						<a href="#"><?php echo $vo['admin_id']; ?></a>
					</td>
					<td class=" "><?php echo $vo['admin_name']; ?></td>
					<td class=" "><?php echo $vo['admin_password']; ?></td>
					<td class=" ">
						<div>
							<a class="green" href="<?php echo url('admin/upd',array('admin_id'=>$vo['admin_id'])); ?>">
								<i style="color: #60ac6d" class="fa fa-pencil"></i>
							</a>
							<a class="red" href="javascript:if(confirm('确认删除？')) location='<?php echo url('admin/del',array('admin_id'=>$vo['admin_id'])); ?>'">
