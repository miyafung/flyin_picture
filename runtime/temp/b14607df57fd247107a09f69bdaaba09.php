<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\keywords\upd.html";i:1515728264;s:83:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\layout.html";i:1516011151;s:90:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\navbar.html";i:1512359202;s:92:"G:\phpStudy2017\PHPTutorial\WWW\layui2\public/../application/admin\view\public\slidebar.html";i:1516011179;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="layui-form" role="form" action="<?php echo url('keywords/updhanddle'); ?>" method="post" enctype="multipart/form-data">
	<input type="hidden" name="keywords_id" value="<?php echo $keywords_find['keywords_id']; ?>">

	<div class="layui-form-item layui-col-md6">
		<label class="layui-form-label">关键词名称</label>
		<div class="layui-input-block">
			<input id="keywords_name" name="keywords_name" placeholder="请输入关键词"  type="text" value="<?php echo $keywords_find['keywords_name']; ?>"  class="layui-input" required>
		</div>
	</div>
